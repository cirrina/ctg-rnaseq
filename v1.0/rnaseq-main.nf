...
//  samplesheets
samplesheet         =  params.samplesheet           // simple sample sheet used for pipeline. Must includes file paths to fastq and bamsm, as well as species etc.
