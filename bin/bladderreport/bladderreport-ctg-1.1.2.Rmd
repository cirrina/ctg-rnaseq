...
# }
  ...
  if(!is.null(params$koncentration)){
    sampledata$koncentration <- params$koncentration
  }
...
Rapportversion  | 1.1.2 - Reviderad 2021-09-17
...
saveRDS(object=results, file=paste0(params$sampleid,".LundClassifier.rds"))
...
if(results$SwitchBox$Subtype$Main_subtype != "Urotel-lik"){
